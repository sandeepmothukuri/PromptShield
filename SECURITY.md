...
If you discover a security issue in PromptShield-Lab itself (not in a simulated attack scenario, which is the point of the lab), please **do not open a public issue**. Instead:

1. Open a private security advisory via GitHub: **Security → Advisories → Report a vulnerability**.
