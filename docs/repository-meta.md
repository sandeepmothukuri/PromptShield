# Repository Metadata (for GitHub UI + SEO)
...
Paste these into GitHub's *Manage topics*:
...
Headline: **PromptShield-Lab**
Subhead:  *AI Security & SOC Detection Lab for the LLM Era*
Footer:   `docker compose up` ・ MIT ・ MITRE ATT&CK ・ OWASP LLM Top 10
